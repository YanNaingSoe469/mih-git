...
urlpatterns = [
    ...
    #project_app routes
    path("create-softwarepj/", project_views.create_software, name="sw_create"),
    path("create-hardwarepj/", project_views.create_hardware, name="hw_create"),
    path("create-aipj/", project_views.create_ai, name="ai_create"),
